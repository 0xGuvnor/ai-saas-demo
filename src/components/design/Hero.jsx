...
export const Gradient = () => {
  return (
    <>
      <div className="z-1 relative mx-2.5 h-6 rounded-b-[1.25rem] bg-n-11 shadow-xl lg:mx-8 lg:h-6" />
      <div className="z-1 relative mx-6 h-6 rounded-b-[1.25rem] bg-n-11/70 shadow-xl lg:mx-20 lg:h-6" />
    </>
  );
};
